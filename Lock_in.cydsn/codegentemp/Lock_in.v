// ======================================================================
// Lock_in.v generated from TopDesign.cysch
// 06/28/2023 at 21:41
...
// TCPWM_PWM_PDL_v1_0(ClockPrescaler=0, Compare0=20000, Compare1=16384, CountInput=7, CountInputMasked=3, DeadClocks=0, EnableCompareSwap=false, EnablePeriodSwap=false, InterruptSource=0, InvertPwm=false, InvertPwm_n=false, KillInput=7, KillInputMasked=3, KillMode=2, Period0=39999, Period1=32768, PwmAlignment=0, PwmMode=4, ReloadInput=7, ReloadInputMasked=3, Resolution=32, RunMode=0, StartInput=7, StartInputMasked=3, SwapInput=7, SwapInputMasked=3, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=TCPWM_PWM_PDL_v1_0, CY_CONFIG_TITLE=L740_PWM, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=L740_PWM, CY_INSTANCE_SHORT_NAME=L740_PWM, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=tcpwm, CY_PDL_DRIVER_REQ_VERSION=1.0.0, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=L740_PWM, )
...
module Scan_ADC_v3_10_1 (
    ...
    defparam SARMUX.input_mode = "000";
...
module SCB_UART_PDL_v2_0_3 (
	...
	cy_clock_v1_0
		#(.id("81e462ea-f089-412c-8c65-19bd79330a3c/b68e5b9d-7828-482d-a282-930f990e3b3e"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	cy_mxs40_gpio_v1_0
		#(.id("81e462ea-f089-412c-8c65-19bd79330a3c/65f3af6c-759b-4ccb-8c66-5c95ba1f5f4f"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("6"),
		  .ibuf_enabled("0"),
	...
	cy_mxs40_gpio_v1_0
		#(.id("81e462ea-f089-412c-8c65-19bd79330a3c/b7e8018e-1ef7-49c0-b5a5-61641a03e31c"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("0"),
		  .ibuf_enabled("1"),
...
// TCPWM_PWM_PDL_v1_0(ClockPrescaler=0, Compare0=10000, Compare1=16384, CountInput=7, CountInputMasked=3, DeadClocks=0, EnableCompareSwap=false, EnablePeriodSwap=false, InterruptSource=0, InvertPwm=false, InvertPwm_n=false, KillInput=7, KillInputMasked=3, KillMode=2, Period0=19999, Period1=32768, PwmAlignment=0, PwmMode=4, ReloadInput=7, ReloadInputMasked=3, Resolution=32, RunMode=0, StartInput=7, StartInputMasked=3, SwapInput=7, SwapInputMasked=3, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=TCPWM_PWM_PDL_v1_0, CY_CONFIG_TITLE=L850_PWM, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=L850_PWM, CY_INSTANCE_SHORT_NAME=L850_PWM, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=tcpwm, CY_PDL_DRIVER_REQ_VERSION=1.0.0, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=L850_PWM, )
...
// TCPWM_PWM_PDL_v1_0(ClockPrescaler=0, Compare0=2500, Compare1=16384, CountInput=7, CountInputMasked=3, DeadClocks=0, EnableCompareSwap=false, EnablePeriodSwap=false, InterruptSource=0, InvertPwm=false, InvertPwm_n=false, KillInput=7, KillInputMasked=3, KillMode=2, Period0=4999, Period1=32768, PwmAlignment=0, PwmMode=4, ReloadInput=7, ReloadInputMasked=3, Resolution=32, RunMode=0, StartInput=7, StartInputMasked=3, SwapInput=7, SwapInputMasked=3, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=TCPWM_PWM_PDL_v1_0, CY_CONFIG_TITLE=SOC_PWM, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=SOC_PWM, CY_INSTANCE_SHORT_NAME=SOC_PWM, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=tcpwm, CY_PDL_DRIVER_REQ_VERSION=1.0.0, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=SOC_PWM, )
...
module top ;
	...
	wire [0:0] tmpFB_0__ADC_INPUT_PIN_0_net;
	wire [0:0] tmpIO_0__ADC_INPUT_PIN_0_net;
	electrical [0:0] tmpSIOVREF__ADC_INPUT_PIN_0_net;
	...
	cy_mxs40_gpio_v1_0
		...
		ADC_INPUT_PIN_0
		 (.oe({1'b1}),
		  .y({1'b0}),
		  .fb({tmpFB_0__ADC_INPUT_PIN_0_net[0:0]}),
		  .analog({Net_40}),
		  .io({tmpIO_0__ADC_INPUT_PIN_0_net[0:0]}),
		  .siovref(tmpSIOVREF__ADC_INPUT_PIN_0_net));


    Scan_ADC_v3_10_1 DETECTOR_ADC (
        .aclk(Net_143),
        .eos(Net_28),
        .sdone(Net_29),
        .soc(Net_200),
	...
	cy_clock_v1_0
		#(.id("4f15d444-6dad-44e0-a41c-4c258a232f92"),
	...
	cy_clock_v1_0
		#(.id("559e85ab-5387-4b48-af18-eb3a1075dc51"),
		  .source_clock_id("2FB4EC85-8328-4C5A-9ED9-8B63060178EB"),
		  .divisor(5),
		  .period("0"),
		  .is_direct(0),
	...
	wire [0:0] tmpFB_0__L740_PWM_PIN_net;
	wire [0:0] tmpIO_0__L740_PWM_PIN_net;
	electrical [0:0] tmpSIOVREF__L740_PWM_PIN_net;
	...
	cy_mxs40_gpio_v1_0
		...
		L740_PWM_PIN
		 (.oe({1'b1}),
		  .y({Net_158}),
		  .fb({tmpFB_0__L740_PWM_PIN_net[0:0]}),
		  .io({tmpIO_0__L740_PWM_PIN_net[0:0]}),
		  .siovref(tmpSIOVREF__L740_PWM_PIN_net));


    TCPWM_PWM_PDL_v1_0_4 L850_PWM (
        .clock(Net_248),
        .compare(Net_260),
        .count(1'b1),
        .interrupt(Net_262),
	...
	cy_clock_v1_0
		#(.id("7cd6f2eb-0c52-429e-9a0f-b2f9ba63c96f"),
		  .source_clock_id("2FB4EC85-8328-4C5A-9ED9-8B63060178EB"),
		  .divisor(5),
		  .period("0"),
		  .is_direct(0),
	...
	wire [0:0] tmpFB_0__L850_PWM_PIN_net;
	wire [0:0] tmpIO_0__L850_PWM_PIN_net;
	electrical [0:0] tmpSIOVREF__L850_PWM_PIN_net;

	cy_mxs40_gpio_v1_0
		#(.id("b28cbb82-c091-4e5e-93ee-a2dffca199e2"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("6"),
		  .ibuf_enabled("0"),
		...
		L850_PWM_PIN
		 (.oe({1'b1}),
		  .y({Net_247}),
		  .fb({tmpFB_0__L850_PWM_PIN_net[0:0]}),
		  .io({tmpIO_0__L850_PWM_PIN_net[0:0]}),
		  .siovref(tmpSIOVREF__L850_PWM_PIN_net));
	...
	cy_clock_v1_0
		#(.id("4855fd7c-b90a-4495-b7a0-c5379b4d62e7"),
		  .source_clock_id("2FB4EC85-8328-4C5A-9ED9-8B63060178EB"),
		  .divisor(5),
		  .period("0"),
		  .is_direct(0),
	...
	wire [0:0] tmpFB_0__ADC_INPUT_PIN_1_net;
	wire [0:0] tmpIO_0__ADC_INPUT_PIN_1_net;
	electrical [0:0] tmpSIOVREF__ADC_INPUT_PIN_1_net;

	cy_mxs40_gpio_v1_0
		#(.id("8ddc348a-da79-4f40-bd15-b802bfbc0f10"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("0"),
		  .ibuf_enabled("0"),
		...
		ADC_INPUT_PIN_1
		 (.oe({1'b1}),
		  .y({1'b0}),
		  .fb({tmpFB_0__ADC_INPUT_PIN_1_net[0:0]}),
		  .analog({Net_317}),
		  .io({tmpIO_0__ADC_INPUT_PIN_1_net[0:0]}),
		  .siovref(tmpSIOVREF__ADC_INPUT_PIN_1_net));


	wire [0:0] tmpFB_0__ADC_INPUT_PIN_2_net;
	wire [0:0] tmpIO_0__ADC_INPUT_PIN_2_net;
	electrical [0:0] tmpSIOVREF__ADC_INPUT_PIN_2_net;

	cy_mxs40_gpio_v1_0
		#(.id("9edba136-645c-4102-aab8-80dabc643021"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("0"),
		  .ibuf_enabled("0"),
		...
		ADC_INPUT_PIN_2
		 (.oe({1'b1}),
		  .y({1'b0}),
		  .fb({tmpFB_0__ADC_INPUT_PIN_2_net[0:0]}),
		  .analog({Net_319}),
		  .io({tmpIO_0__ADC_INPUT_PIN_2_net[0:0]}),
		  .siovref(tmpSIOVREF__ADC_INPUT_PIN_2_net));
	...
	cy_mxs40_gpio_v1_0
		#(.id("20f4f30a-189b-4cb1-bd02-b92665cfb0f1"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("6"),
		  .ibuf_enabled("0"),
